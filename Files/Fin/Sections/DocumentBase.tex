...
\begin{titlepage}
    \begin{center}
        ...
        \vspace*{0.5cm}
        \LARGE
        \textbf{System katalogów bibliotecznych}\\
        \Large
        Projekt baz danych
        \vspace*{0.5cm}
        \rule{500pt}{1pt}
    ...
    {\raggedright
        \large
        \textbf{Autor sprawozdania:} Michał Dziedziak 263901, Michał Zapała 263935\\
        \textbf{Imię i Nazwisko prowadzącego kurs:} Dr inż. Marcin Łopuszyński\\
        \textbf{Dzień i godzina zajęć:}  Wtorek, 17:05 - 18:45
    }
\end{titlepage}

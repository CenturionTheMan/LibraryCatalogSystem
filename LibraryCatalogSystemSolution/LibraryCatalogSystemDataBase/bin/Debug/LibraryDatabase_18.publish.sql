...
GO
PRINT N'Altering View [dbo].[SummarisedResources]...';


GO

ALTER VIEW SummarisedResources AS
SELECT
    R.ResourceID,
    R.Title,
...
GO
PRINT N'Altering View [dbo].[UserWithBorrowedResources]...';
...
----------------------------------------------------------------------------- VIEWS
ALTER VIEW UserWithBorrowedResources AS
SELECT
    U.UserID,
    R.ResourceID,
    R.Title,

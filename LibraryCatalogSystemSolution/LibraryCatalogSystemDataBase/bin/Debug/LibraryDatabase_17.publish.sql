...
:setvar DefaultDataPath "C:\Users\zapal\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
:setvar DefaultLogPath "C:\Users\zapal\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
...
GO
ALTER TABLE [dbo].[ResourceCopies]
    ADD FOREIGN KEY ([ResourceID]) REFERENCES [dbo].[Resources] ([ResourceID]);
